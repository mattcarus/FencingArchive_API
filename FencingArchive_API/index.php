<?php
/**
 * The FencingArchive API.
 * 
 * This is the main request router for the FencingArchive.net API
 * 
 * @author       Matt Carus <matt@fencingarchive.net>
 */
...
require_once 'assets/twitter/twitter.php';
require_once 'assets/fencingarchive/FA.class.php';

// Initialise the Slim Application
$app = new \Slim\Slim();

/**
 * The default base route.
 * 
 * This just displays basic info about the server. At the moment
 * this is a Slim Framework holding page. This should change
 * 
 * @return string HTML info page
 */
$app->get(
    '/',
    function () {
...
$app->get('/image/:id', function ($id) {
    if(is_numeric($id)) {
        ...
        $app->response->headers->set('Content-Type', $row['mime']);
...
$app->put(
    '/put',
    function () {
        echo 'PUT methods are not implemented';
    }
);

// PATCH route
$app->patch('/patch', function () {
    echo 'PATCH methods are not implemented';
});
...
$app->delete(
    '/delete',
    function () {
        echo 'DELETE methods are not implemented';
    }
);
...
class Twitter
{
	...
	public function statusesUserTimeline(
		$userId = null, $screenName = null, $sinceId = null,
		$count = null, $maxId = null, $trimUser = null,
		$excludeReplies = null, $contributorDetails = null, $includeRts = null
	)
	{
		// validate
